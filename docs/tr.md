...
2. Выполнение тестов после изучения теоретических материалов на закрепление самых важных знаний по теме.
3. Выполнение практических задач, прикреплённых к топикам.
4. Решение алгоритмических задач (не привязанных к темам).
5. Автоматическая проверка решений с возвратом результата.  
6. Поддержка системы разнопланового взаимодействия между пользователями
7. Анализ успеваемости отедельного пользователя с целью улучшения системы взаимодействия
...
1. Пользователь открывает топик.
2. Пользователь изучает материал.
3. Пользователю предлагается пройти тест по модулю из теоретических вопросов и вариантов ответа.
...
1. Пользователь в клиентском приложении выбирает теоретический модуль.  
...
4. `Course Service` возвращает описание теоретического материала и тестовых вопросов.  
5. Пользователь изучает материал.  
6. Пользователь проходит небольшой тест по теоретическому модулю с вопросами и вариантами ответов. После выбора варианта ответа пользователю сразу показывается правильный(он скрыт интерфейсом до выбора любого варианта пользователем).
