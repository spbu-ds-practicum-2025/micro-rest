...
5. Поддержка системы разнопланового взаимодействия между пользователями
6. Анализ успеваемости отедельного пользователя с целью улучшения системы взаимодействия
...
6. Пользователь может пройти небольшой тест по теоретическому модулю с вопросами и вариантами ответов.
